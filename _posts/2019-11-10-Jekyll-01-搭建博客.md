...
[root@tianxiang ~]# pwd
/usr/share/GeoIP
[root@tianxiang GeoIP]# wget https://blog.linuxtian.top/data/GeoLite2-Country_20221011.tar.gz
[root@tianxiang GeoIP]# wget https://blog.linuxtian.top/data/GeoLite2-City_20230210.tar.gz
...
server {
    ...
    return 301 https://blog.linuxtian.top$request_uri;
      ...
      location / {
        ...
        #  }
        # 访问地区不等于yes的说明是不允许访问的国家,跳转403状态码
        if ($allowed_country != yes) {
          return 403;
          }
        }
...
server {
        ...
        ssl_certificate /etc/nginx/conf.d/cert/blog.linuxtian.top.cer;
...
[root@localhost ~]# vim /etc/nginx/error/html/404.html   # 代码：https://blog.linuxtian.top/data/error/404.html
[root@localhost ~]# vim /etc/nginx/error/html/50.html   # 代码：https://blog.linuxtian.top/data/error/50.html
