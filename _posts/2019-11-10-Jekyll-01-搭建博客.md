...
<head>
    ...
    <script>
        window.onload = function() {
            ...
            var footerText = '冀ICP备<a href="https://beian.miit.gov.cn">xxxxx</a> | 版权所有 &copy; ' + currentYear + ' <a href="https://blog.linuxtian.top">blog.linuxtian.top</a>';
...
<body>
    <div class="container">
        <div class="content">
            <h1>欢迎访问我的网站</h1>
            <p>这是默认页面，请访问<a href="http://blog.linuxtian.top">blog.linuxtian.top</a>来打开我的博客。</p>
        </div>
