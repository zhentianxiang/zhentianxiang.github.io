...
[root@tianxiang GeoIP]# wget https://blog.linuxtian.top/data/1-jekyll%E5%8D%9A%E5%AE%A2%E7%9B%B8%E5%85%B3/GeoLite2-Country_20221011.tar.gz
[root@tianxiang GeoIP]# wget https://blog.linuxtian.top/data/1-jekyll%E5%8D%9A%E5%AE%A2%E7%9B%B8%E5%85%B3/GeoLite2-City_20230609.tar.gz
...
server {
        ...
        ssl_certificate /etc/nginx/cert/blog.linuxtian.top.cer;
        ssl_certificate_key /etc/nginx/cert/blog.linuxtian.top.key;
...
[root@localhost ~]# vim /etc/nginx/error/html/403.html   # 代码：https://blog.linuxtian.top/data/1-jekyll%E5%8D%9A%E5%AE%A2%E7%9B%B8%E5%85%B3/html/403.html
[root@localhost ~]# vim /etc/nginx/error/html/50.html   # 代码：https://blog.linuxtian.top/data/1-jekyll%E5%8D%9A%E5%AE%A2%E7%9B%B8%E5%85%B3/html/50.html
...
[root@tianxiang jekyll-build]# docker build . -t jekyll-ruby2.6.0:v1.0 \
    ...
    --build-arg "NO_PROXY=localhost,10.96.0.10"
...
[root@tianxiang jekyll-build]# docker run -d --name jekyll-ruby2.6.0 -p 4000:4000 -v /myBlog/jekyll-template:/myBlog/jekyll-template  --restart=always jekyll-ruby2.6.0:v1.0
[root@tianxiang jekyll-build]# docker ps -l
CONTAINER ID        IMAGE               COMMAND                  CREATED             STATUS              PORTS                    NAMES
0e4e68c41445        jekyll-ruby2.6.0:v1.0         "/usr/local/bin/bund…"   3 seconds ago       Up 1 second         0.0.0.0:4000->4000/tcp   jekyll-v1.0
```
